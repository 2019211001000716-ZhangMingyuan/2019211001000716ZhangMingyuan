			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.ZhangMingyuan.model.Order o=(com.ZhangMingyuan.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.ZhangMingyuan.dao.UserDao userDao=new com.ZhangMingyuan.dao.UserDao();
						...
						<%
							...
							String paymentType=com.ZhangMingyuan.model.Payment.findByPaymentId(con,n);
							 %>
